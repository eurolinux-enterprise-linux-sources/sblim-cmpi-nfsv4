...
#define yyparse NFSv4yyparse
#define yylex   NFSv4yylex
#define yyerror NFSv4yyerror
#define yylval  NFSv4yylval
#define yychar  NFSv4yychar
#define yydebug NFSv4yydebug
#define yynerrs NFSv4yynerrs
...
{
       0,     0,     3,     4,     7,     8,    12,    15,    16,    23,
      25,    29,    35,    43,    45,    47,    51
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      14,     0,    -1,    -1,    15,    14,    -1,    -1,     7,    16,
      17,    -1,     8,     9,    -1,    -1,     8,     3,    10,     7,
      18,    19,    -1,     9,    -1,    11,    20,     9,    -1,    11,
       4,    10,    21,     9,    -1,    11,    20,    11,     4,    10,
      21,     9,    -1,     6,    -1,    22,    -1,    22,    12,    21,
      -1,     5,    -1
};
...
{
       0,    64,    64,    65,    69,    69,    93,    94,    94,   102,
     103,   104,   105,   108,   116,   117,   120
};
#endif
...
{
  "$end", "error", "$undefined", "PSEUDO", "SECURITY", "SECURITY_VALUE",
  "PERMISSION", "PATHNAME", "'('", "')'", "'='", "','", "':'", "$accept",
  "stanzas", "stanza", "@1", "options", "@2", "permsec", "permission",
  "security_values", "security_value", 0
};
#endif
...
{
       2,     4,     0,     2,     0,     1,     3,     0,     5,     0,
       6,     0,     7,     0,     9,     0,     8,     0,    13,     0,
       0,    10,     0,    16,     0,    14,     0,    11,     0,     0,
      15,     0,    12
};
...
{
       3,   -21,    11,     3,     4,   -21,   -21,    -3,   -21,     5,
     -21,     6,   -21,    -8,   -21,    -2,   -21,     7,   -21,    -4,
       9,   -21,    12,   -21,    10,     8,    13,   -21,     9,     9,
     -21,    15,   -21
};
...
{
       9,    14,    17,    15,    18,    21,    10,    22,    30,    31,
       1,     5,     7,    12,    23,    11,    26,    20,     0,    27,
      28,     6,     0,    29,    32
};

static const yytype_int8 yycheck[] =
{
       3,     9,     4,    11,     6,     9,     9,    11,    28,    29,
       7,     0,     8,     7,     5,    10,     4,    10,    -1,     9,
      12,     3,    -1,    10,     9
};
...
{
       0,     7,    14,    15,    16,     0,    14,     8,    17,     3,
       9,    10,     7,    18,     9,    11,    19,     4,     6,    20,
      10,     9,    11,     5,    21,    22,     4,     9,    12,    10,
      21,    21,     9
};
...
#line 79 "util/parser/parser.y"
  ...
  case 7:
#line 94 "util/parser/parser.y"
    {
				startproperty("PseudoPath",CMPI_string);
				setvalue((yyvsp[(4) - (4)].string)); free((yyvsp[(4) - (4)].string));
				endproperty();
				}
    break;

  case 13:
#line 108 "util/parser/parser.y"
    {
				startproperty("Permission",CMPI_string);
                                setvalue((yyvsp[(1) - (1)].string)); free((yyvsp[(1) - (1)].string));
                                endproperty();
				}
    break;

  case 16:
#line 120 "util/parser/parser.y"
    {
				secname = malloc(strlen((yyvsp[(1) - (1)].string))+10);
				sprintf(secname, "Security_%s", (yyvsp[(1) - (1)].string));
				free((yyvsp[(1) - (1)].string));
